...
while count != 0:
    print(count)
    count = count - 1
print('end') # надо принтовать не делая tab, тк может выводить через каждое число слово end
# получаем числа от 10 до 0 и в конце вывoдит end

a = 0
while a:
    print('hello') # не работает вообще потому, что bool(a) False
