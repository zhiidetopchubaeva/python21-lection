...
class B(A):
    """Наследовали все аттрибуты и методы у класса А"""
...
"super()- функция, которая позволяет обратиться к родительскому классу и вызвать определенные метолы и аттрибуты"
class A:
    def my_range(self, n):
...
# множественное наследование - Нааследование от 2 или больше классов
...
class C(A,B):
    """Наследовались от 2 классов A, B"""
    c = "c"
