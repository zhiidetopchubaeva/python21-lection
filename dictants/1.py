"""
Создать список из чисел в диапозоне от 1 до 10
"""
# 1
...
"""
В список добавить по индексу 2 число11
"""
# 1
list1.insert(2, 11)
# 2
...
""""
Создайте класс Person c аттрибутами класса arms = 2, legs = 2 и аттрибутом объекта name
"""
# 1
class Person:
    arms = 2
